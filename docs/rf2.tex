...
%                                                                     %
%                                     2006                            %
%    Modificado por: Daniel Aicardi, Edgardo Vaz, Melina Rabinovich.  %
%                                     2011                            %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\hyphenation{co-nex-ión}
\hyphenation{Open-Embedded}
\hyphenation{bootargs}
\hyphenation{lec-to-res}
\hyphenation{man-te-ni-mien-to}
\hyphenation{mo-ne-de-ro}
...
\part{Apéndices}
\appendix
\include{Anexos/smartcards}
\include{Anexos/antena}
\include{Anexos/docHW}
\include{Anexos/sw}
%Hojas de datos
\include{Anexos/pdf}
