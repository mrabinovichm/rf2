...
\bibitem{Angs} Angström, http://www.angstrom-distribution.org/
\bibitem{Angs_MLO} MLO, http://www.angstrom-distribution.org/demo/beagleboard/MLO/
\bibitem{Narc} Narcissus, http://narcissus.angstrom-distribution.org/
\bibitem{termios} termios, http://pubs.opengroup.org/onlinepubs/007908799/xsh/termios.h.html
\bibitem{Make} Make, http://es.wikipedia.org/wiki/Make
