%\documentclass[handout]{beamer}	% para imprimir las diapositivas
%\usepackage{pgfpages}				% para imprimir las diapositivas
	...
	\begin{columns}
		\begin{column}{9cm}
			\begin{itemize}
				...
				\bigskip
				\item <3-> Dispositivo a bordo que debita viajes
				...
				\begin{itemize}
					\item <6-> Servidores - establece reglas de negocio
					\item <6-> Seguridad
...
\begin{frame}
	...
	\begin{center}
		...
		\begin{tabular}{c|c}
			...
			orientado a ethical hacking & orientado a sistema embebido\\
			interfaz USB & interfaz SPI\\
...
\begin{frame}
	...
	\end{itemize}
	\begin{itemize}
		\item <4-> fileSystem, sistema de archivos de la distribución
...
\begin{frame}
	...
	\begin{center}
		\includegraphics <2-> [scale=.3]{Imagenes/SW.jpg}
	\end{center}
	\begin{itemize}
		\item <3-> librfid, desarrollada para OpenPCD
		...
		\bigskip
		\item <6-> libgpio, completamente implementada
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\end{itemize}
	\begin{itemize}
		\item <4-> Aplicación final basada en librfid-tool

		\bigskip
		\item <5-> Lectura completa de tarjeta

		\bigskip
		\item <6-> Lectura/escritura de un bloque específico
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{8cm}
			\begin{itemize}
				\item <2-> Posiblemente, primer lector/escritor RFID 13,56MHz diseñado y fabricado en 								   Uruguay
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{6cm}
			\begin{itemize}
				...
				\begin{itemize}
					...
					\bigskip		
					\item <6-> Multipropósito
					\begin{itemize}
						\item <7-> Sistema de transporte
						\item <7-> Venta de servicios
						\item <7-> Control de acceso
						\item <7-> Marcas de personal
					\end{itemize}
				\end{itemize}
			\end{itemize}
		\end{column}
		...
		\bigskip
			\includegraphics <7-> [scale=.15]{Imagenes/acceso2.jpg}
		
			\bigskip
			\includegraphics <7-> [scale=.2]{Imagenes/pago2.jpg}
	...
	\begin{columns}	
		\begin{column}{10cm}
			\begin{itemize}
				...
				\bigskip
				\item <4-> Solución académica a un problema real

				\bigskip
				\item <5-> Las empresas deberían buscar soluciones tecnológicas a través de la Universidad 						   como referente de conocimiento. 			
			\end{itemize}
		\end{column}
		\begin{column}{2cm}
			\begin{center}
				\includegraphics <5-> [scale=.3]{Imagenes/udelar.jpg}
			\end{center}
		\end{column}
	\end{columns}
\end{frame}
