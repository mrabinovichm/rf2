...
\bigskip
Al iniciar la aplicación, se realiza la inicialización de los distintos módulos que conforman el sistema (interfaz de usuario y habilitación de comunicación con módulo lector/escritor RFID, pin RST\_RF). Ésto se realiza mediante la función inicio\_rf2. Luego se abre el puerto de comunicación con el lector/escritor RFID. Con estos pasos finaliza la inicialización del sistema y se ingresa al loop principal de la aplicación.
...
\bigskip
Cambios en la aplicación RF$ ^{2} $ para demo:
